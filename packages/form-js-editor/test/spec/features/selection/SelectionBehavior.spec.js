...
describe('features/selection', function () {
  ...
  it('should select new form field', inject(function (
    formEditor,
    modeling,
    selection,
  ) {
  ...
  it('should select moved form field', inject(function (
    formEditor,
    formFieldRegistry,
    modeling,
    selection,
  ...
  it('should select next form field on remove', inject(function (
    formEditor,
    formFieldRegistry,
    modeling,
    selection,
  ...
  it('should deselect form field on undo', inject(function (
    commandStack,
    formEditor,
    modeling,
    selection,
