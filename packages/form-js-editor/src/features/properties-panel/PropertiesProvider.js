  ...
  getGroups(field, editField) {
    return (groups) => {
      ...
      groups = [
        ...
        ...TableHeaderGroups(field, editField, getService),
        SecurityAttributesGroup(field, editField, getService),
        ConditionGroup(field, editField, getService),
        LayoutGroup(field, editField, getService),
        AppearanceGroup(field, editField, getService),
        SerializationGroup(field, editField, getService),
        ConstraintsGroup(field, editField, getService),
        ValidationGroup(field, editField, getService),
        CustomPropertiesGroup(field, editField, getService),
