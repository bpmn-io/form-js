...
const LABEL_DESCRIPTION_ERROR_STYLES = css`
  .fjs-container {
    ...
    /* Carbon sizes the control itself, so the base offset for the native one does not apply */
    .fjs-form-field-checkbox .fjs-inline-label > .fjs-form-field-label,
    .fjs-form-field-checklist .fjs-inline-label > .fjs-form-field-label,
    .fjs-form-field-radio .fjs-inline-label > .fjs-form-field-label {
      margin-top: 0;
    }
