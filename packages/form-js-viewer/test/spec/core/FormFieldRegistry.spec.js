...
describe('FormFieldRegistry', function () {
  ...
  describe('#add', function () {
    ...
    it('should throw error if form field with ID already exists', inject(function (
      ...
      // when
      // then
      expect(() => formFieldRegistry.add(formField)).to.throw(
        'form field with ID foo already exists',
      );
    }));

    it('should emit event when form field is added', inject(function (
      eventBus,
      formFieldRegistry,
    ) {
      // given
  ...
  describe('#remove', function () {
    ...
    it('should emit event when form field is removed', inject(function (
      eventBus,
      formFieldRegistry,
    ) {
      // given
  ...
  describe('#forEach', function () {
    ...
    it('should execute callback for all form fields', inject(function (
      formFieldRegistry,
    ) {
      // given
  ...
  describe('#clear', function () {
    ...
    it('should clear on form.clear', inject(function (
      eventBus,
      formFieldRegistry,
    ) {
      // when
