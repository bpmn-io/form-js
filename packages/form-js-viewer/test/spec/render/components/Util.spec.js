  ...
  describe('#formFieldClasses', function () {
    ...
    it('should contain errors class', function () {
      ...
      expect(classes).to.equal(
        'fjs-form-field fjs-form-field-button fjs-has-errors',
      );
    });
  });
...
<img src="https://via.placeholder.com/1000x150" alt="some big image"></p>
    ...
    it('should create link', function () {
      ...
      expect(html).to.equal(
        '<p>at <a href="http://foo">varius</a> turpis nunc eget.</p>',
      );
    });
...
<p>Do <a href="http://localhost">this</a>, not <strong>that</strong>.</p>
  ...
  describe('safeMarkdown', function () {
    ...
    it('should remove disallowed tags', function () {
      ...
      // then
      expect(html).to.equal(
        '<div xmlns="http://www.w3.org/1999/xhtml"><h1>Foo</h1></div>',
      );
    });
    ...
    it('should add <rel="noopener"> to target="_blank" links', function () {
      ...
      // then
      expect(html).to.equal(
        '<div xmlns="http://www.w3.org/1999/xhtml"><a target="_blank" href="/g" rel="noopener"></a></div>',
      );
    });
    ...
    it('should remove bogus target from links', function () {
      ...
      // then
      expect(html).to.equal(
        '<div xmlns="http://www.w3.org/1999/xhtml"><a href="/g"></a></div>',
      );
    });
    ...
    describe('should remove <javascript:> href attributes', function () {
      it('basic', function () {
        // given
        const markdown =
          "<a href=\"javascript:throw onerror=alert,'some string',123,'haha'\">Foo</a>";
        ...
        // then
        expect(html).to.equal(
          '<div xmlns="http://www.w3.org/1999/xhtml"><a>Foo</a></div>',
        );
      });
